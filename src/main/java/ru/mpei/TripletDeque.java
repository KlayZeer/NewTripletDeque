...
public class TripletDeque<E> implements Deque<E>, Containerable {
    private class Container<E> {
        private Container<E> next; //Ссылка на следующий контейнер в очереди
        private Container<E> prev; //Ссылка на предыдущий контейнер в очереди
        private Object[] elementData; //Массив элементов
    ...
    private Container<E> first; //Ссылка на первый контейнер в очереди
    private Container<E> last; //Ссылка на последний контейнер в очереди
    private int initialCapacity; //Максимальное количество элементов в контейнере
    private int queueVolume; //Максимальное количество элементов в очереди
    ...
    private void checkAmountOfElements() throws IllegalStateException {
        if (amountOfElements == queueVolume) {
            throw new IllegalStateException("В очереди закончились свободные места!");
        }
    }
